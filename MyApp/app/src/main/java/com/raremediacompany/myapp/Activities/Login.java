...
//    @BindView(R.id.send_otp_active)
 ...
 //   @BindView(R.id.label_to_enter_mobile)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mobileNoET = (AppCompatEditText)findViewById(R.id.mobileNumET);
        sendOtpInactive = (ImageButton)findViewById(R.id.send_otp_inactive);
        sendOtpactive = (ImageButton)findViewById(R.id.send_otp_active);
        parentLayout = (LinearLayout)findViewById(R.id.parentLayout);
//        label = (TextView)findViewById(R.id.label_to_enter_mobile1);
...
//        ButterKnife.bind(this);
        login = this;
//        label.setTypeface(mFontRegular);
//        mobileNoET.setTypeface(mFontRegular);
        ...
        sendOtpactive.setOnClickListener(new View.OnClickListener() {
            @Override
