...
public class PreferenceforApp {
    ...
    public void setCheckedInTimestamp(String timestamp) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString("checkedInTimeStamp", timestamp);
        editor.commit();
    }

    public String getCheckedTimestamp() {
        return prefs.getString("checkedInTimeStamp", "00:00");
    }

    public void setCheckedInMillis(long timestamp) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putLong("checkedInMillis", timestamp);
        editor.commit();
    }

    public long getCheckedInMillis() {
        return prefs.getLong("checkedInMillis", 0);
    }
