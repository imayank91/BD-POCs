...
public class BeaconScannerFragment extends Fragment implements Scanner.OnScanBeaconsListener {
...
//        checkFirstRun();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View beaconListView = inflater.inflate(R.layout.fragment_beaconlist, container, false);
...
//        this.beacons = (List<Beacon>) beacons;
        ...
        for (Beacon beacon : beacons) {
            ...
            if (vicinityBeacons != null ) {
                ...
                if(vicinityBeacons.getMajor().equalsIgnoreCase("26871")
                        && vicinityBeacons.getMinor().equalsIgnoreCase("64367")) {
...
//        RealmResults<RMCBeacon> rmcBeacon = realm.where(RMCBeacon.class).findAll();

//        if (rmcBeacon != null && rmcBeacon.size() > 0) {
//            for (final RMCBeacon beacon : rmcBeacon) {
//                Date date = beacon.getLastseen();
//                Date currentDate = new Date();
//
//                long twoMinsBackMillis = currentDate.getTime() - 18000;
//                if (twoMinsBackMillis > date.getTime()) {
//
//                    realm.executeTransaction(new Realm.Transaction() {
//                        @Override
//                        public void execute(Realm realm) {
//                            beacon.setStatus("out");
//                            beacon.setMarked(false);
...
//
//                    if(beacon.getMajor().equalsIgnoreCase("26871")) {
//
//                        BDCloudUtils.sendNotification("You left the RMC office", getActivity(), null, i);
//                    }
//                }
//            }
//
