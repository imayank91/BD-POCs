...
//        }
    ...
    private void startScanning() {
        if (!beaconManager.checkAvailability()) {
            ...
            beaconManager.bind(scanner); // Beacon manager BindViews the beacon consumer and starts service.
            startAnimation();
        }
    }
    ...
    private void stopScanning() {
        ...
        beaconManager.unbind(scanner); // Beacon manager unBindViews the beacon consumer and stops service.
        stopAnimation();
    }
